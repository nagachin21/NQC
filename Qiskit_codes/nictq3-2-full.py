...
#測定結果のカウント表示
print("Total count [y3,y2,y1,y0,x8,x7,x6,x5,x4,x3,x2,x1,x0]:",counts)

#10進変換追記部分
scounts = sorted(counts.items(), key=lambda x:x[0][4:13]) #xbitsの順にソート
#print(scounts)
for i in scounts:
	k=i[0]
	v=i[1]
	ybits = k[0:4]    #文字列kの0-3文字目を取り出す
	xbits = k[4:13]     #文字列kの4-7文字目を取り出す
